...
\begin{proof}
    ...
    \begin{align*}
        ...
        = \bigcup_{k = 0}^{i+1} AltFORM_k
    \end{align*}
    \begin{align*}
        \phi \in \bigcup_{k = 0}^i AltFORM_k \rightarrow \phi \in \bigcup_{k = 0}^{i+1} AltFORM_k\\
        \exists \psi \in  \bigcup_{k = 0}^i AltFORM_k \rightarrow \exists j \leq i, \psi \in AltFORM_j \rightarrow \forall \phi = (\neg \psi), \psi \in AltFORM_j, \phi \in AltFORM_{j+1}\\
...
Give two distinct formation sequences that belong to the given formula.

\begin{lemma}
$\mathrm{INDFORM} = \{ w \in \Sigma^* \mid w \text{ is formation-sequence-well-formed} \}$.
\end{lemma}
